...
//        //TODO: if token exist this will complete the email field with the email saved
//        if(Token.hasToaken(getApplicationContext())){
//            mEmailView.setText(Token.getToken(getApplicationContext()));
//        }
...
//            showProgress(true);
//            mAuthTask = new UserLoginTask(email, password,this.findViewById(android.R.id.content).getRootView());
...
//        private View myView;
//
//        UserLoginTask(String email, String password,View view) {
//            mEmail = email;
//            mPassword = password;
//            myView=view;
//        }
...
//                jsonParams.put("userEmail", mEmail);
...
//                            Toast.makeText(myView.getContext(), authToken+" "+"Login success!", Toast.LENGTH_LONG).show();
//                        }
//                    }
//
//                    @Override
...
//                                break;
//                            default:
//                                Toast.makeText(myView.getContext(), "Contact support!", Toast.LENGTH_LONG).show();
//                        }
//                    }
//                });
//
