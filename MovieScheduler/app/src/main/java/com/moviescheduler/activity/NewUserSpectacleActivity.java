...
public class NewUserSpectacleActivity extends AppCompatActivity {
    ...
    void onAddNewUserTicket(String seatNumber){
        ...
        long userId=1;
        //String url = "https://back-end-school-project.herokuapp.com/api/new-user-ticket/seatNumber="+seatNumber+"&userId="+userId+"&spectacleSchedule="+selectedIdSchedule+"";
        String url="https://back-end-school-project.herokuapp.com/api/new-user-ticket/seatNumber="+seatNumber+"&userId="+1+"&spectacleSchedule="+selectedIdSchedule;
        AsyncHttpClient client = new AsyncHttpClient();

        client.addHeader(TOKEN_NAME,TOKEN_VALUE);

        client.post(getApplicationContext(), url, null, "application/json", new AsyncHttpResponseHandler() {
                    @Override
